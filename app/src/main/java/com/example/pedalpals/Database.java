...
public class Database extends SQLiteOpenHelper {
    ...
    public static final String USER_COL_5="city";
    public static final String USER_COL_6="state";
    ...
    public boolean insertData_User(String first_name,String last_name,String email,String state,String city, String username, String password, String mobile_number) {
        ...
        contentValues.put(USER_COL_5, city);
        contentValues.put(USER_COL_6, state);
    ...
    public boolean updateData_User(String username, String first_name, String last_name, String email, String state,String city, String mobile_number) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public boolean updateData_User_pass(String username, String first_name, String last_name, String email, String state,String city, String password, String mobile) {
        SQLiteDatabase db = this.getWritableDatabase();
