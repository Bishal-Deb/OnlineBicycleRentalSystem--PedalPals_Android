...
public class AdminTransactionDetails extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    TextView name_tv, email_tv, state_tv, user_rating_tv, mobile_tv;
    TextView owner_name_tv, owner_email_tv, owner_state_tv, owner_rating_tv, owner_mobile_tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        state_tv = findViewById(R.id.hall);
        ...
        owner_state_tv = findViewById(R.id.owner_hall);
    ...
    private void showData(){
        ...
        state_tv.setText(str_usr[4] + " " + str_usr[3]);
        ...
        owner_state_tv.setText(str_owner[4] + " " + str_owner[3]);
